"""Captured download history for a canonical prisoner."""
...
class PrisonerDownload(Base):
    """Download entry with protocol and observed timestamp."""

    __tablename__ = "prisoner_downloads"
    ...
    prisoner: Mapped["Prisoner"] = relationship("Prisoner", back_populates="downloads")
